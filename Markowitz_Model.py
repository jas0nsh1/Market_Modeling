...
# stocks we are going to analyze
...
# what are the contraints? The sum of weights = 1 !!!
...
def show_optimal_portfolio(opt, rets, potfolio_rets, portfolio_vols):
    plt.figure(figsize=(10, 6))
    plt.scatter(portfolio_vols, potfolio_rets, c=potfolio_rets/portfolio_vols, marker='o')
    plt.grid(True)
    plt.xlabel('Expected Volatility')
    plt.ylabel('Expected Return')
    plt.colorbar(label='Sharpe Ratio')
