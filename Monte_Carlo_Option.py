...
class OptionPricing:
    ...
    def call_option_simulation(self):
        ...
        # we need S-E because we have to calcualte the max(S-E,0)
    ...
    def put_option_simulation(self):
        ...
        # dimensions: 1 dimensional arqray with as many items as the iterations
        rand = np.random.normal(0, 1, [1,self.iterations])
        ...
        # we need S-E because we have to calcualte the max(E-S,0)
